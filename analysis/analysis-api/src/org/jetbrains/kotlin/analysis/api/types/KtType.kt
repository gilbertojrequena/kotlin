...
public abstract class KtDynamicType : KtType {
    /**
     * Potential lower bound of the dynamic type
     */
    protected abstract val lowerBound: KtType

    /**
     * Potential upper bound of the dynamic type
     */
    protected abstract val upperBound: KtType
